...
class FMP():
    ...
    API_KEY = json.load(open("./config/api.json"))['key']
    ...
    URL = {
        ...
        "all_indexes" : "https://financialmodelingprep.com/api/v3/symbol/available-indexes"
        }
...
index_all = fin.index_all
prices_indexes = fin.prices_indexes
...
############################### indexes Prices ################################
    ...
    fin.prices_indexes.insert_many(df_prices_index.to_dict('records'))
